...
static inline uint16_t X(uint16_t ins) {
    return (ins & 0x0f00) >> 8;
}

static inline uint16_t Y(uint16_t ins) {
    return (ins & 0x00f0) >> 4;
}

static inline uint16_t N(uint16_t ins) {
    return ins & 0x000f;
}

static inline uint16_t NN(uint16_t ins) {
    return ins & 0x00ff;
}

static inline uint16_t NNN(uint16_t ins) {
    return ins & 0x0fff;
}
...
static inline void clear_screen(Emulator *emulator) {
    ...
    memset(emulator->graphics, 0, DISPLAY_WIDTH * DISPLAY_HEIGHT);
}
